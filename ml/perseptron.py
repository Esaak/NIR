...
def main():
    ...
    metrics = trainer.train(
        data['X_train'],
        # data['y_train'],
        pd.DataFrame(data=np.array(data['y_train']["c_delta_y"]), columns=["c_delta_y"]),
        epochs=config['training_params']['epochs'],
        batch_size=config['training_params']['batch_size'],
        # validation_data=(data['X_val'], data['y_val']),
        validation_data=(data['X_val'], pd.DataFrame(data=np.array(data['y_val']["c_delta_y"]), columns=["c_delta_y"])),
    ...
    y_pred, rmse_loss = trainer.evaluate(data['X_test'], pd.DataFrame(data=np.array(data['y_test']["c_delta_y"]), columns=["c_delta_y"]))
